...
const PRODUCTS = [
  ...
  {id:"rl-sp260310pmh6", name:"Light Wash Distressed Denim Shorts", cat:"Shorts", price:70, was:0, color:"Light Wash", tag:"BEST SELLER", rating:4.7, reviews:88, sizes:["S","M","L","XL","XXL"], oos:["S","XXL"], photos:["rl-sp260310pmh6-front.jpg","rl-sp260310pmh6-side.jpg","rl-sp260310pmh6-back.jpg","rl-sp260310pmh6-detail.jpg"], desc:"Loose wide-leg denim jorts in a light wash, finished with heavy rips and an irregular frayed hem for real streetwear grit."},
  {id:"rl-sp26061297av", name:"Camo 3/4 Cargo Shorts", cat:"Shorts", price:86, was:0, color:"Green Camo", tag:"NEW", rating:4.8, reviews:42, sizes:["S","M","L","XL"], oos:[], photos:["rl-sp26061297av-front.jpg","rl-sp26061297av-side.jpg","rl-sp26061297av-back.jpg","rl-sp26061297av-detail.jpg"], desc:"Cotton ripstop camo cargos in a longer 3/4 length. Relaxed straight fit, reinforced flap pockets, and bar-tack stitching at the stress points."},
  {id:"rl-sp260616fa60", name:"Military Wide-Leg Cargo Shorts", cat:"Shorts", price:92, was:0, color:"Washed Camo", tag:"NEW", rating:4.8, reviews:61, sizes:["S","M","L","XL","XXL"], oos:["XXL"], photos:["rl-sp260616fa60-front.jpg","rl-sp260616fa60-side.jpg","rl-sp260616fa60-back.jpg","rl-sp260616fa60-detail.jpg"], desc:"Wide-leg military cargos in a vintage-washed camo, cut long and roomy with stacked utility pockets, webbing straps and buckle detailing. A dramatic, runway-ready short."},
  {id:"rl-sp260602ah0q", name:"Cargo Multi-Pocket Denim Jorts", cat:"Shorts", price:72, was:88, color:"Washed Denim", tag:"SALE", rating:4.6, reviews:64, sizes:["M","L","XL","XXL"], oos:["M"], photos:["rl-sp260602ah0q-hero.jpg"], desc:"Cotton denim cargo jorts with a soft wash, wide-leg silhouette, raw hem, and a reinforced multi-pocket layout. Utility with an attitude."},
  {id:"rl-sp260514qcbq", name:"Industrial Cargo Shorts", cat:"Shorts", price:116, was:0, color:"Waxed Black", tag:"", rating:4.9, reviews:37, sizes:["M","L","XL","XXL"], oos:["M"], photos:["rl-sp260514qcbq-hero.jpg"], desc:"Heavyweight waxed-denim cargos with a multi-dimensional pocket build, distressed raw hem, and a faded charcoal finish. A premium, lived-in statement."},
  {id:"rl-sp2607079rsc", name:"Drawstring Distressed Shorts", cat:"Shorts", price:82, was:0, color:"Faded Black", tag:"", rating:4.7, reviews:49, sizes:["S","M","L","XL","XXL"], oos:["S"], photos:["rl-sp2607079rsc-hero.jpg"], desc:"Relaxed cotton-blend shorts with a brushed hand-feel, elastic drawstring waist, back patch pockets, and a subtle faded wash. Easy everyday comfort."},
  ...
  {id:"rl-sp251204c5s2", name:"Patchwork Layered Hoodie", cat:"Hoodies", price:118, was:0, color:"Charcoal", tag:"NEW", rating:4.8, reviews:53, sizes:["S","M","L","XL"], oos:["XL"], photos:["rl-sp251204c5s2-hero.jpg"], desc:"Two-tone patchwork hoodie with a layered raw-edge hem, distressed detailing, and a heavyweight brushed-back interior. Oversized and lived-in."},
  {id:"rl-sp260302osst", name:"Studded Utility Cargo Pants", cat:"Bottoms", price:98, was:0, color:"Field Olive", tag:"", rating:4.7, reviews:38, sizes:["S","M","L","XL","XXL"], oos:["M","XXL"], photos:["rl-sp260302osst-hero.jpg"], desc:"Heavyweight utility cargo pants in a faded field olive, finished with decorative stud work and roomy flap pockets. Straight-leg, workwear-built."},
  {id:"rl-sp260311wpc1", name:"Rope-Detail Wide-Leg Sweatpants", cat:"Bottoms", price:88, was:0, color:"Heather Grey", tag:"", rating:4.7, reviews:59, sizes:["S","M","L","XL"], oos:["M"], photos:["rl-sp260311wpc1-hero.jpg"], desc:"Wide-leg heavyweight sweatpants with a chunky decorative rope drawcord and a rounded barrel leg. Elevated loungewear with a sculptural shape."},
  {id:"rl-sp251117fbbn", name:"Pinstripe Pleated Wide-Leg Pants", cat:"Bottoms", price:92, was:0, color:"Charcoal Pinstripe", tag:"NEW", rating:4.7, reviews:44, sizes:["S","M","L","XL","XXL"], oos:["XXL"], photos:["rl-sp251117fbbn-hero.jpg"], desc:"Pleated wide-leg trousers in a tonal pinstripe with a dramatic barrel silhouette. Tailored on top, voluminous through the leg."},
  ...
  {id:"rl-sp250402sntq", name:"Pleated Drape Trousers", cat:"Bottoms", price:96, was:118, color:"Slate / Black", tag:"SALE", rating:4.7, reviews:36, sizes:["S","M","L","XL","XXL"], oos:["M"], photos:["rl-sp250402sntq-hero.jpg"], desc:"Pleated drape trousers with a soft woven hand and an architectural wide leg. Clean-fit waist, fluid movement — smart-casual done street."},
  {id:"rl-sp260817for3", name:"Frayed Patchwork Bomber Jacket", cat:"Jackets", price:148, was:0, color:"Washed Grey", tag:"NEW", rating:4.8, reviews:37, sizes:["S","M","L","XL"], oos:["S"], photos:["rl-sp260817for3-hero.jpg"], desc:"Cropped bomber with raw-edge patchwork seams criss-crossing a washed heavyweight body. Ribbed hem and cuffs, boxy modern fit."},
  ...
  {id:"rl-sp251117bhmv", name:"Crackle-Washed Barrel Jeans", cat:"Denim", price:116, was:0, color:"Crackle Blue", tag:"NEW", rating:4.7, reviews:64, sizes:["S","M","L","XL","XXL"], oos:["L"], photos:["rl-sp251117bhmv-hero.jpg"], desc:"Barrel-cut jeans in a striking crackle wash. Voluminous through the thigh, tapered at the ankle — a real statement denim."},
  {id:"rl-sp250715s7eb", name:"Distressed Dirty-Wash Jeans", cat:"Denim", price:112, was:0, color:"Dirty Wash", tag:"", rating:4.6, reviews:73, sizes:["S","M","L","XL","XXL"], oos:["L"], photos:["rl-sp250715s7eb-hero.jpg"], desc:"Straight-leg jeans with a dirty vintage wash, subtle repairs, and faded whiskering. Looks like you have had them for years."},
  {id:"rl-sp250612jts0", name:"Light Wash Barrel Jeans", cat:"Denim", price:114, was:134, color:"Light Wash", tag:"SALE", rating:4.7, reviews:88, sizes:["S","M","L","XL","XXL"], oos:["M"], photos:["rl-sp250612jts0-hero.jpg"], desc:"Baggy barrel jeans in a bright light wash with soft fading. Rounded leg, cropped cuff — peak Y2K denim."},
  ...
  {id:"rl-parachute-cargo-shorts", name:"Parachute Cargo Shorts", cat:"Shorts", price:78, was:0, color:"Slate Grey", tag:"NEW", rating:4.7, reviews:34, sizes:["S","M","L","XL","XXL"], oos:["XL"], photos:["rl-parachute-cargo-shorts-hero.jpg"], desc:"Lightweight nylon parachute shorts with cinch toggles, bellowed cargo pockets, and a relaxed drop. Built for movement."},
  ...
  {id:"rl-stacked-flare-jeans", name:"Stacked Flare Jeans", cat:"Denim", price:132, was:0, color:"Washed Blue", tag:"NEW", rating:4.8, reviews:63, sizes:["S","M","L","XL","XXL"], oos:["S"], photos:["rl-stacked-flare-jeans-hero.jpg"], desc:"Extra-long flared denim built to stack over your sneakers, with subtle whiskering and a mid-rise waist."},
  {id:"rl-carpenter-wideleg-jeans", name:"Carpenter Wide-Leg Jeans", cat:"Denim", price:126, was:0, color:"Mid Indigo", tag:"", rating:4.7, reviews:48, sizes:["S","M","L","XL","XXL"], oos:["M","L"], photos:["rl-carpenter-wideleg-jeans-hero.jpg"], desc:"14oz carpenter jeans with a hammer loop, utility pockets, and a true wide-leg drape. Rigid denim that breaks in."},
  ...
  {id:"rl-suede-western-jacket", name:"Suede Western Jacket", cat:"Jackets", price:214, was:0, color:"Tobacco", tag:"", rating:4.7, reviews:22, sizes:["S","M","L","XL"], oos:["L"], photos:["rl-suede-western-jacket-hero.jpg"], desc:"Faux-suede western jacket with yoke seams, snap front, and a soft brushed hand. A refined layering piece."},
  ...
  {id:"rl-fleece-work-jacket", name:"Fleece-Lined Work Jacket", cat:"Jackets", price:176, was:0, color:"Washed Olive", tag:"", rating:4.8, reviews:31, sizes:["S","M","L","XL","XXL"], oos:["L"], photos:["rl-fleece-work-jacket-hero.jpg"], desc:"Cotton-canvas chore jacket lined in sherpa fleece, with triple-needle stitching and utility pockets."},
  {id:"rl-nylon-parachute-pants", name:"Nylon Parachute Pants", cat:"Bottoms", price:98, was:0, color:"Black", tag:"NEW", rating:4.7, reviews:66, sizes:["S","M","L","XL","XXL"], oos:["S"], photos:["rl-nylon-parachute-pants-hero.jpg"], desc:"Billowy nylon parachute pants with adjustable toggles at the waist and hem. Techwear-ready volume."},
  ...
  {id:"rl-wool-wideleg-trousers", name:"Wide-Leg Wool Trousers", cat:"Bottoms", price:112, was:0, color:"Grey Marl", tag:"", rating:4.7, reviews:33, sizes:["S","M","L","XL"], oos:["XL"], photos:["rl-wool-wideleg-trousers-hero.jpg"], desc:"Drapey wool-blend trousers with front pleats and a wide, fluid leg. Smart-casual done street."},
  {id:"rl-ripstop-cargo-jogger", name:"Ripstop Cargo Jogger", cat:"Bottoms", price:88, was:0, color:"Field Olive", tag:"BEST SELLER", rating:4.8, reviews:121, sizes:["S","M","L","XL","XXL"], oos:["L"], photos:["rl-ripstop-cargo-jogger-hero.jpg"], desc:"Tapered ripstop joggers with bellowed cargo pockets and adjustable hem toggles. Everyday utility."},
  {id:"rl-balloon-sweatpants", name:"Balloon-Fit Sweatpants", cat:"Bottoms", price:84, was:0, color:"Ash Grey", tag:"", rating:4.6, reviews:44, sizes:["S","M","L","XL","XXL"], oos:["M"], photos:["rl-balloon-sweatpants-hero.jpg"], desc:"Heavyweight fleece sweatpants with a rounded balloon leg and ribbed cuff. Cozy, sculptural comfort."},
  ...
  {id:"rl-washed-zip-hoodie", name:"Washed Zip-Up Hoodie", cat:"Hoodies", price:108, was:0, color:"Washed Black", tag:"NEW", rating:4.7, reviews:62, sizes:["S","M","L","XL","XXL"], oos:["M","L"], photos:["rl-washed-zip-hoodie-hero.jpg"], desc:"Garment-washed full-zip hoodie with matte hardware and a heavyweight, lived-in hand."},
  ...
  {id:"rl-raw-edge-hoodie", name:"Distressed Raw-Edge Hoodie", cat:"Hoodies", price:112, was:0, color:"Vintage Black", tag:"", rating:4.6, reviews:37, sizes:["S","M","L","XL"], oos:["XL"], photos:["rl-raw-edge-hoodie-hero.jpg"], desc:"Deconstructed hoodie with raw exposed seams, subtle distressing and an oversized drape."},
  {id:"rl-cropped-hoodie", name:"Cropped Boxy Hoodie", cat:"Hoodies", price:88, was:0, color:"Cement", tag:"", rating:4.6, reviews:41, sizes:["S","M","L","XL"], oos:["XL"], photos:["rl-cropped-hoodie-hero.jpg"], desc:"Shortened, boxy hoodie with a wide ribbed hem. Layers clean over longline tees."},
  {id:"rl-sherpa-hoodie", name:"Sherpa-Lined Hoodie", cat:"Hoodies", price:124, was:0, color:"Chocolate", tag:"NEW", rating:4.8, reviews:29, sizes:["S","M","L","XL","XXL"], oos:["M","XL"], photos:["rl-sherpa-hoodie-hero.jpg"], desc:"Heavy hoodie lined with plush sherpa through the body and hood. Serious cold-weather warmth."},
  ...
  {id:"rl-contrast-stitch-hoodie", name:"Contrast-Stitch Hoodie", cat:"Hoodies", price:102, was:0, color:"Off White", tag:"", rating:4.5, reviews:26, sizes:["S","M","L","XL"], oos:["XL"], photos:["rl-contrast-stitch-hoodie-hero.jpg"], desc:"Inside-out construction with exposed contrast stitching and a heavyweight loopback interior."},
