...
const PRODUCTS = [
  ...
  {id:"rl-reversible-bucket-hat", name:"Reversible Bucket Hat", cat:"Headwear", price:42, was:0, color:"Camo / Black", tag:"", rating:4.6, reviews:37, sizes:["OS"], oos:[], photos:["rl-reversible-bucket-hat-hero.jpg"], desc:"Two hats in one — camo on one side, solid on the other, with embroidered eyelets."},
  {id:"rl-knit-balaclava", name:"Knit Balaclava Hood", cat:"Headwear", price:38, was:0, color:"Black", tag:"", rating:4.5, reviews:24, sizes:["OS"], oos:[], photos:["rl-knit-balaclava-hero.jpg"], desc:"Ribbed knit balaclava that wears as a hood or neck gaiter. A winter techwear essential."},
];
