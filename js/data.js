...
const PRODUCTS = [
  ...
  {id:"rl-sp260813qpa7", name:"Chunky Rib Knit Beanie", cat:"Headwear", price:32, was:0, color:"Cream / Black", tag:"BEST SELLER", rating:4.9, reviews:134, sizes:["OS"], oos:[], photos:["rl-sp260813qpa7-hero3.jpg"], desc:"Soft chunky-rib acrylic beanie with a deep cuff. Warm, stretchy, one-size-fits-most. Shown in cream and black."},
  {id:"rl-sp260813zdsh", name:"Corduroy Slouchy Beanie", cat:"Headwear", price:30, was:0, color:"Black / Cream", tag:"NEW", rating:4.7, reviews:58, sizes:["OS"], oos:[], photos:["rl-sp260813zdsh-hero3.jpg"], desc:"Lightweight corduroy-knit slouchy beanie with a longline fit. Wear it cuffed or slouched."},
  {id:"rl-sp2606081gvu", name:"Vintage Washed Dad Cap", cat:"Headwear", price:28, was:0, color:"Washed Blue / Tan", tag:"", rating:4.7, reviews:96, sizes:["OS"], oos:[], photos:["rl-sp2606081gvu-hero3.jpg"], desc:"Six-panel dad cap in a vintage washed cotton with hand-distressed edges and a curved brim. Adjustable strap back."},
